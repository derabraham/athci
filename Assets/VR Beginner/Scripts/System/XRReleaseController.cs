...
/// <summary>
/// This is a special type of ActionBasedController that programmatically toggles select for one frame.
/// This keeps the original teleport-trigger logic so that the MasterScript can trigger
/// a select on the front push of the thumbstick to teleport.
/// </summary>
public class XRReleaseController : ActionBasedController
{
    bool m_Selected;
